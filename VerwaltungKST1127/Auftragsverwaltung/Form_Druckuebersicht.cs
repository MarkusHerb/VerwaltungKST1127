...
namespace VerwaltungKST1127.Auftragsverwaltung
{
    ...
    public partial class Form_Druckuebersicht : Form
    {
        ...
        // Verbindung zur "alten" Verwaltungs-Datenbank (Spiegel). Wird parallel befüllt, damit
        // Programme, die noch aus SOA127_Verwaltung lesen, die rausgeschriebenen Aufträge sehen.
        ...
        private void btnDruckAuftragszettel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(lblSeite1.Text))
                {
                    ...
                    SchreibeInProdOrdersStamm(lblPositionVergueten1.Text, lblArbeitsvorgangVergueten1.Text, lblAvoNrZuVergueten1.Text, lblSeite1.Text, serienlinsenDaten);
                }
                if (!string.IsNullOrEmpty(lblSeite2.Text))
                {
                    ...
                    SchreibeInProdOrdersStamm(lblPositionVergueten2.Text, lblArbeitsvorgangVergueten2.Text, lblAvoNrZuVergueten2.Text, lblSeite2.Text, serienlinsenDaten);
                }
                if (!string.IsNullOrEmpty(lblSeite3.Text))
                {
                    ...
                    SchreibeInProdOrdersStamm(lblPositionVergueten3.Text, lblArbeitsvorgangVergueten3.Text, lblAvoNrZuVergueten3.Text, lblSeite3.Text, serienlinsenDaten);
                }
                if (!string.IsNullOrEmpty(lblSeite4.Text))
                {
                    ...
                    SchreibeInProdOrdersStamm(lblPositionVergueten4.Text, lblArbeitsvorgangVergueten4.Text, lblAvoNrZuVergueten4.Text, lblSeite4.Text, serienlinsenDaten);
                }

                // Den frisch geschriebenen Stand auf den alten Server (SOA127_Verwaltung) spiegeln.
                SpiegleProdOrdersStammAufAltenServer();
